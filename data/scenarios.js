const scenarios = [
  ...
  // ==================================================
  {
    ...
    solutionTasks: [],
    subScenarios: [
      { code: "3692",role: "GF5",title: "Herzlich Willkommen zur Funkübung der Feuerwehr Stadt Geestland in Imsum. Folgen Sie der folgenden Navigaion zu Ihrem Einsatzort",
      ...
      { code: "7925",role: "GF5",title: "Sie haben den Einsatzort erreicht.",
      ...
      { code: "8627",role: "GF5",title: "Sie haben Ihre Einsatzstelle erreicht. ",
      ...
      { code: "4932",role: "AT5",title: "Der Fahrradfahrer ist nur leicht verletzt. Er berichtet, dass der Motoradfahrer weiter die Straße richtung Deich gelaufen sei.",
      ...
      { code: "7520",role: "AT5",title: "Sie haben den Motorradfahrer gefunden. Er liegt neben der Straße im Grünstreifen. Er atmet, reagiert aber nicht auf Ansprache.",
       description: "Person",
      ...
      { code: "8461",role: "WT5",title: "Stark beschädigtes Fahrzeug im Straßengraben. Sie können keine Fahrer feststellen",
       description: "PKW",
       fileType: "image",file: "/images/8461.jpg",
       tasks: ["Übermitteln sie Ihre Information  über Funk an den GF-Trupp",],
       solutionTasks: ["Fahrzeug","kein Fahrer",],},
      
      { code: "3795",role: "WT5",title: "Eine Passantin gibt an, dass die Fahrerin in Richtung Wohnhaus gelaufen ist.",
       description: "Passantin",
       fileType: "image",file: "/images/3795.jpg",
       tasks: ["Übermitteln sie Ihre Information  über Funk an den GF-Trupp","Setzen sie im Anschluss ihre Erkundung in entsprechende Richtung fort.",],
       solutionTasks: ["Passantin","Richtung",],},
      
      { code: "5802",role: "WT5",title: "Sie haben die Fahrerin festgestellt. Sie reagirt auf Ansprach, hat aber Schmerzen.",
       description: "Person",
       fileType: "image",file: "/images/5802.jpg",
       tasks: ["Übermitteln sie Ihre Information  über Funk an den GF-Trupp","Setzen sie im Anschluss ihre Erkundung in fort.",],
       solutionTasks: ["Fahrerin","leicht verletzt","Schmerzen",],},
      
      { code: "6109",role: "WT5",title: "Sie stellen aus der Entfernung eine Rauchentwicklung im Motorraum des Unfallfahrzeuges fest.",
