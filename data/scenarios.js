const scenarios = [
  ...
  // ==================================================
  {
    ...
    solutionTasks: ["Richtige Lageeinschätzung vorgenommen","Wasserversorgung vollständig aufgebaut","Alle Personen im Keller gefunden","Brandbekämpfung eingeleitet",],
    subScenarios: [
      {code: "1112",title: "Person gefunden",description: "Eine verletzte Person wird im Keller aufgefunden.",tasks: ["Erste Hilfe leisten", "Rettung vorbereiten"],solutionTasks: ["Person korrekt versorgt", "Transport eingeleitet"],},
      {code: "1113",title: "Atemschutznotfall",description: "Ein Truppmitglied meldet Atemschutzprobleme.",tasks: ["Notfallmeldung absetzen", "Rettungstrupp einsetzen"],solutionTasks: ["Notfall korrekt gemeldet", "Trupp sicher gerettet"],},
      {code: "1114",title: "Brand breitet sich aus",description: "Die Flammen schlagen auf das Erdgeschoss über.",tasks: ["Zweite Leitung vornehmen", "Brandabschnitt sichern"],solutionTasks: ["Brand erfolgreich eingedämmt"],},
      {code: "1115",title: "Gasflaschen im Keller",description: "Beim Suchen entdeckt ihr mehrere Gasflaschen.",tasks: ["Gasflaschen sichern", "Gefahrenbereich absperren"],solutionTasks: ["Gasflaschen in Sicherheit gebracht"],},
      {code: "1116",title: "Einsatz beendet",description: "Der Einsatzleiter erklärt die Übung für beendet.",tasks: ["Material zurückbauen", "Meldung an Einsatzleitung"],solutionTasks: ["Rückbau vollständig durchgeführt"],},
    ],
  },
